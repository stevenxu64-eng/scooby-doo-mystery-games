...
export const NOTEBOOK_NOTES: NotebookNote[] = [
  ...
  { flag: 'met_rosa', kind: 'event', text: "Met Rosa Delgado — forty years of housekeeping, still on duty, entirely unbothered by phantoms." },
  { flag: 'rosa_heyday', kind: 'clue', text: "Rosa: Room 217 was George Palm Sr.'s PRIVATE SUITE — the finest room in the house." },
  { flag: 'rosa_wail', kind: 'clue', text: "Rosa hears the phantom's wail coming from UNDER the cabana. Ghosts don't take service tunnels — staff do." },
  { flag: 'rosa_blazer', kind: 'clue', text: 'Rosa still presses Crane’s staff blazer WEEKLY. Midnight caretaking, freshly laundered.' },
  ...
  { flag: 'tomas_nine', kind: 'clue', text: 'Tomás: the moonflowers open at NINE SHARP every night — something walks the greenhouse on a schedule.' },
  { flag: 'tomas_trip', kind: 'clue', text: 'Tomás watched the phantom TRIP on his roses and swear like a sailor. Ghosts float; frauds stumble.' },
  { flag: 'met_ghost', kind: 'event', text: 'Met an ACTUAL ghost: George Palm Sr. himself. Polite, luminous, and furious about the impostor.' },
